...
export const CSS_PROPERTY_GROUPS = {
  ...
  appearance: {
    ...
    properties: {
      "background-color": { name: "背景颜色", type: "color" },
      "background-image": { name: "背景图片", type: "text", placeholder: "url(image.jpg) 或 linear-gradient(...)" },
      "background-size": { name: "背景尺寸", type: "select", options: ["auto", "cover", "contain", "100%", "100% 100%", "50%", "200px", "200px 100px"] },
      "background-repeat": { name: "背景重复", type: "select", options: ["repeat", "no-repeat", "repeat-x", "repeat-y", "space", "round"] },
      "background-position": { name: "背景位置", type: "select", options: ["center", "top", "bottom", "left", "right", "top left", "top right", "bottom left", "bottom right", "center top", "center bottom"] },
      "background-attachment": { name: "背景附着", type: "select", options: ["scroll", "fixed", "local"] },
      "background-clip": { name: "背景裁剪", type: "select", options: ["border-box", "padding-box", "content-box", "text"] },
      "background-origin": { name: "背景原点", type: "select", options: ["border-box", "padding-box", "content-box"] },
      "background-blend-mode": { name: "背景混合模式", type: "select", options: ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"] },
      color: { name: "文字颜色", type: "color" },
      border: { name: "边框", type: "text" },
